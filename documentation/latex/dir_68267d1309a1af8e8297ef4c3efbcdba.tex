...
\begin{DoxyCompactList}\small\item\em ESP32-\/based temperature monitoring and data logging system using DS18\+B20 sensor. \end{DoxyCompactList}\end{DoxyCompactItemize}
